 ...
 * @author Wasmake
 */
public class BungeeClickActions implements Listener {
     ...
     */
    private static BungeeClickActions instance;
    /**
     ...
     */
    public static BungeeClickActions getInstance() {
        return instance == null ? (instance = new BungeeClickActions()) : instance;
    }
     ...
     */
    public TextComponent sendActionMessage(ProxiedPlayer player, String msg, boolean expire, PlayerAction action) {
     ...
     * @param action    The action to execute when the player clicks the message
     */
    public TextComponent sendActionMessage(ProxiedPlayer player, TextComponent component, boolean expire, PlayerAction action) {
     ...
     * @param action     The action to execute when the player clicks the message
     */
    public TextComponent sendActionMessage(ProxiedPlayer player, TextComponent[] components, boolean expire, PlayerAction action) {
     ...
     */
    public void removeActionMessages(ProxiedPlayer player) {
        if (actionMap.isEmpty() || actionMap == null) return;
